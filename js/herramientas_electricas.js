...
db.collection("herramientas_electricas").get().then((querySnapshot) => {
    querySnapshot.forEach((doc) => {
        $(".herramientas_electricas").append("<hr class='featurette-divider'> " + 
        	...
        	"<a href= '../html/producto_ejemplo.html'> <img onClick='crearDocumento(), setCookie(\"nom_producto\",\"" +doc.data().Nombre+ "\",1),"
        	+"setCookie(\"nom_coleccion\",\"herramientas_electricas\",1)' src=" + doc.data().Imagen + " width='150' height='125'> </a>"
