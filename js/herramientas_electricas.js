...
db.collection("herramientas_electricas").get().then((querySnapshot) => {
    querySnapshot.forEach((doc) => {
        $(".herramientas_electricas").append("<hr class='featurette-divider'> " + 
        	...
        	"<a href= 'https://console.firebase.google.com/project/ferreteria-81897/database/firestore/data~2FIluminacion_bombillas~2FZIUOgWGxiWEZ01K6Ule9'> <img src=" + doc.data().Imagen + " width='150' height='125'> </a>"
